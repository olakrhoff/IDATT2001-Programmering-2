...
class MaleIndividual extends Individual {
   ...
   */
  public MaleIndividual(String norName, String latName, String latFamily, LocalDate arrivalDate,
                        String name, LocalDate dateOfBirth, boolean isDangerous, String address)
  {
