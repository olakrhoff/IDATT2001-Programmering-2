...
public class ContactsApp extends Application {
  ...
  //private AddressBookPlain addressBookPlain;
  private AddressBookDBHandler addressBookDBHandler;
  ...
  public void init() throws Exception {
    ...
    //this.addressBookPlain = this.mainController.loadAddressBookFromFile();
    this.addressBookDBHandler = new AddressBookDBHandler(this.mainController.loadEMF());
  ...
  public void stop() {
    ...
    //this.mainController.saveAddressBookToFile(this.addressBookPlain);
    // Exit the application
    this.addressBookDBHandler.close();
    System.exit(0);
  }
  ...
  private ObservableList<ContactDetails> getAddressBookListWrapper() {
    ...
    this.addressBookListWrapper = FXCollections.observableArrayList(this.addressBookDBHandler.getAllContacts());
  ...
  private ToolBar createToolBar() {
    ...
    addContactBtn.setOnAction(actionEvent -> mainController.addContact(this.addressBookDBHandler, this));
    ...
    editContactBtn.setOnAction(event ->
        mainController.editContact(
          this.contactDetailsTableView.getSelectionModel().getSelectedItem(), this, this.addressBookDBHandler));
...
/*
    ...
    importFromCsv.setOnAction(event -> mainController.importFromCsv(this.addressBookPlain, this));
    menuFile.getItems().add(importFromCsv);

    MenuItem exportToCsv = new MenuItem("Export to .CSV...");
    exportToCsv.setOnAction(event -> mainController.exportToCsv(this.addressBookPlain));
...
*/
    ...
    addContactMenu.setOnAction(event -> mainController.addContact(this.addressBookDBHandler, this));
    ...
    editContactMenu.setOnAction(event ->
        mainController.editContact(this.contactDetailsTableView.getSelectionModel().getSelectedItem(), this, this.addressBookDBHandler));
    ...
    removeContactMenu.setOnAction(event -> mainController.deleteContact(
        this.contactDetailsTableView.getSelectionModel()
          .getSelectedItem(), this.addressBookDBHandler, this));
